...
namespace Demo
{
    class Program
    {
        ...
        {
            #region INFO
            //A bug is a programmer mistake that should be fixed before
            //    the code is made available to users.

            //Exceptions are raised as a result of problems that you can
            //predict, but can’t prevent,
            //because they depend on factors outside your program.
            //A network connection dropping suddenly, or running
            //out of disk space...

            //An error is caused by user action. The user might enter a
            //number where a letter is expected.
            //An error might cause an exception, but you can
            //prevent that by implementing code to validate user
            //input
            #endregion
            ...
            //Console.WriteLine("-------------------- Custom Exception 2 --------------------");
            //Console.WriteLine("Enter the letter a or b");
            //try
            //{
            //    string letter = Console.ReadLine();
            ...
            //        customException.HelpLink = "google.com";
            //        customException.CustomDescription = $"You enter letter: {letter}, instead of a/b.";
            //        throw customException;
            ...
            //Console.WriteLine("-------------------- Specific Exceptions --------------------");
            //Console.WriteLine("Enter a number");
            //try
            //{
            //    int number = Int32.Parse(Console.ReadLine());
            ...
            //Console.WriteLine("-------------------- Inside Function Exception --------------------");
            //Human h = new Human();
            //h.Name = "Bob";
            //HumanSkill(h);
            #endregion
            ...
            //Console.WriteLine("-------------------- Selective Exception handling --------------------");
            //try
            //{
            //    Human h = new Human();
            //    h.Name = "Bob";
            ...
            //Console.WriteLine("-------------------- BestPractice to close file OR DB connection in finally block --------------------");
            //WriteToFileOrDatabase("1fd");
            #endregion

            #region BestPractice 2 place exception handlers as close as you can to the exception
            Console.WriteLine("-------------------- BestPractice 2 place exception handlers as close as you can to the exception --------------------");
            //try
            //{
            //    Method1();
            //}
