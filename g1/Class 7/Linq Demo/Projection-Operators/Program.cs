    ...
    class Program {
        ...
        static void Main(string[] args) {
            ...
            var productInfos = products.Select(p =>
                    new { p.ProductName, CategoryID = p.CategoryId, Price = p.UnitPrice });
            ...
            var custOrders =
                    ...
                    select new { c.CompanyName, OrderID = o.OrderId, o.OrderDate };
            ...
            var custOrders2 = customers.SelectMany(c => orders, (c, o)
                         => new { c.CompanyName, OrderID = o.OrderId, o.OrderDate }).
